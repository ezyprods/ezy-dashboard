...
export default function PortalPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary font-sans antialiased pb-20 selection:bg-accent selection:text-text-primary">
        ...
        <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-lg font-bold text-text-primary tracking-tight">Portal de {data.artist.name}</h1>
            </div>
          </div>
