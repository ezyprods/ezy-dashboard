...
export function FolderExplorerModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 animate-in fade-in duration-150">
      ...
      {/* Modal Dialog */}
      <div className="relative w-full max-w-2xl h-[75vh] max-h-[680px] bg-surface border border-border shadow-2xl rounded-2xl flex flex-col animate-in zoom-in-95 duration-150 overflow-hidden transform-gpu z-10">
        ...
        <div className="px-4 py-2 border-b border-border/50 flex items-center gap-2 shrink-0 bg-surface/50">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-surface border border-border/60 rounded-lg pl-8 pr-8 py-1.5 text-xs text-text-primary placeholder:text-text-secondary/70 focus:outline-none focus:border-accent"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex bg-surface border border-border/60 rounded-lg p-0.5 gap-0.5">
            <button
              ...
              className={cn("p-1.5 rounded-md transition-colors", viewMode === 'list' ? "bg-accent text-white" : "text-text-secondary hover:text-text-primary")}
            >
              <List className="w-3.5 h-3.5" />
            </button>
            <button
              onClick={() => setViewMode('grid')}
              className={cn("p-1.5 rounded-md transition-colors", viewMode === 'grid' ? "bg-accent text-white" : "text-text-secondary hover:text-text-primary")}
            >
              ...
              {displayItems.map(item => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "group flex items-center gap-3 px-5 py-2.5 cursor-pointer transition-colors border-l-2",
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={cn("text-sm font-semibold truncate", isActive || isHl ? "text-accent" : "text-text-primary")}>
                        ...
                        {isHl && (
                          <span className="ml-2 text-[9px] font-bold bg-accent/20 text-accent px-1.5 py-0.5 rounded-full align-middle">
                            este archivo
                          </span>
                        )}
                      </p>
              ...
              {displayItems.map(item => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "group flex flex-col p-3 rounded-xl border transition-all cursor-pointer select-none",
                  ...
                  >
                    ...
                    {isHl && (
                      <span className="mt-1 text-[9px] font-bold bg-accent/20 text-accent px-1.5 py-0.5 rounded-full self-start">
                        aquí
                      </span>
                    )}
        ...
        <div className="px-5 py-2.5 border-t border-border/50 flex items-center justify-between text-xs text-text-secondary shrink-0 bg-surface/50">
          ...
          <button
            onClick={onClose}
            className="px-3 py-1.5 rounded-lg hover:bg-surface-elevated transition-colors font-medium text-text-primary"
          >
            Cerrar
          </button>
        </div>
