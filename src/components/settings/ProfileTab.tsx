          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-semibold text-text-secondary uppercase tracking-wider flex items-center gap-2">
                <Building className="w-3.5 h-3.5" /> Nombre del Estudio
              </label>
              <input
                type="text"
                name="studioName"
                ...
                className="w-full bg-surface-elevated border border-border focus:border-accent rounded-xl px-4 py-3 text-sm text-text-primary outline-none transition-colors"
              />
            </div>
